 ...
 */
package de.harich.thilo.factoring.algorithm.ecm.util;

import java.math.BigInteger;

import static de.harich.thilo.factoring.algorithm.ecm.util.JacobiSymbol.I_0;
import static de.harich.thilo.factoring.algorithm.ecm.util.JacobiSymbol.I_1;
