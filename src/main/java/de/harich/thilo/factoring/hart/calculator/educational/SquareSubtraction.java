...
public class SquareSubtraction {
    ...
    public int getLoopEnd(long numberToFactorize){
        int runtime = (int) (4* Math.cbrt(numberToFactorize));
        int valuesPerRegister = 8; // AVX-512 can hold 8 long (= 64 bit) values
        return valuesPerRegister * (runtime / valuesPerRegister) ;
    }
